...
const StepHikeCompact: FC<PropsWithChildren<IStepHikeCompact>> &
  IStepHikeCompactSubcomponents = ({ children, title }) => {
...
const Details: FC<PropsWithChildren<IDetails>> = ({
  children,
  title,
  fullWidth = false,
}) => {
  return (
    <div
      className={cn(
        fullWidth ? "col-span-12" : "col-span-5",
        "ml-12",
        "lg:ml-0"
      )}
    >
