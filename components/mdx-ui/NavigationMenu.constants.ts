...
import type { IconPanel } from "@/components/mdx-ui/IconPanel";

import type {
  GlobalMenuItems,
  NavMenuConstant,
  NavMenuSection,
} from "@/components/mdx-ui/Navigation.types";
...
export const PhoneLoginsItems = [
  {
    ...
    linkDescription:
      "Communication between businesses and their customers — across any channel.",
  ...
  },
  {
    ...
    linkDescription:
      "Customer engagement platform used by hundreds of thousands of businesses.",
  },
  {
    name: "Vonage",
  ...
  },
  {
    ...
    linkDescription:
      "Textlocal is a cloud-based SMS platform offering bulk messaging services.",
  },
];
  ...
  items: [
      ...
      items: [
        ...
        { name: "Identities", url: "/guides/auth/identities" },
        {
          ...
          items: [
            {
              name: "Implicit flow",
              url: "/guides/auth/sessions/implicit-flow",
            },
    ...
    },
    {
      ...
      items: [
        ...
        {
          name: "Firebase Auth",
          url: "/guides/auth/third-party/firebase-auth",
        },
        { name: "Auth0", url: "/guides/auth/third-party/auth0" },
        {
          name: "AWS Cognito (Amplify)",
          url: "/guides/auth/third-party/aws-cognito",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        {
          name: "Auth UI (Deprecated)",
          url: "/guides/auth/auth-helpers/auth-ui",
        },
        {
      ...
      items: [
        {
          ...
          url: "/guides/functions/dependencies",
        },
        {
...
export const realtime: NavMenuConstant = {
  ...
  items: [
    ...
    },
    {
      ...
      items: [
        {
          name: "Operational Error Codes",
          url: "/guides/realtime/error_codes",
          items: [],
        },
      ],
    },
...
export const storage: NavMenuConstant = {
  ...
  items: [
    ...
    },
    {
      ...
      items: [
        {
          name: "Copy / Move Objects",
          url: "/guides/storage/management/copy-move-objects",
        },
        {
          name: "Delete Objects",
          url: "/guides/storage/management/delete-objects",
        },
      ],
    },
    {
  ...
  items: [
    { name: "Overview", url: "/guides/local-development" },
    {
      ...
      items: [
        {
          name: "Getting started",
          url: "/guides/local-development/cli/getting-started",
        },
    ...
    },
    {
      ...
      items: [
        {
          name: "Getting started",
          url: "/guides/local-development/testing/overview",
        },
        {
    ...
    },
    {
      ...
      items: [
        ...
        { name: "SSL Enforcement", url: "/guides/platform/ssl-enforcement" },
        {
          ...
          url: "/guides/platform/permissions",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          url: "/guides/deployment/managing-environments",
        },
        {
          name: "Database migrations",
          url: "/guides/deployment/database-migrations",
        },
    ...
    },
    {
      ...
      items: [
        { name: "Terraform provider", url: "/guides/deployment/terraform" },
        {
          ...
          url: "/guides/deployment/terraform/tutorial",
        },
        {
          name: "Terraform reference",
          url: "/guides/deployment/terraform/reference",
        },
      ],
    },
    {
