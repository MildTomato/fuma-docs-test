import * as CURL from "@/components/open-api/requests/curl";
import * as JS from "@/components/open-api/requests/javascript";
import * as Go from "@/components/open-api/requests/go";
import * as Python from "@/components/open-api/requests/python";
import type {
  MethodInformation,
  RenderContext,
} from "@/components/open-api/types";
import type { EndpointSample } from "@/components/open-api/utils/generate-sample";
import { type ReactNode } from "react";
import { Markdown } from "@/components/open-api/render/markdown";
import { type CodeSample } from "@/components/open-api/render/operation";
import type { ResponseTypeProps } from "@/components/open-api/render/renderer";
import { getTypescriptSchema } from "@/components/open-api/utils/get-typescript-schema";
