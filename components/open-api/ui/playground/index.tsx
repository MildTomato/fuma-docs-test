...
import { useApiContext } from "@/components/open-api/ui/contexts/api";
import type { FetchResult } from "@/components/open-api/ui/playground/fetcher";
import {
  getDefaultValue,
  getDefaultValues,
} from "@/components/open-api/ui/playground/get-default-values";
import {
  FieldSet,
  ObjectInput,
} from "@/components/open-api/ui/playground/inputs";
import type {
  APIPlaygroundProps,
  PrimitiveRequestField,
  RequestSchema,
} from "@/components/open-api/render/playground";
import { type DynamicField, SchemaContext } from "../contexts/schema";
import { getStatusInfo } from "@/components/open-api/ui/playground/status-info";
import { getUrl } from "@/components/open-api/utils/server-url";
import { DynamicCodeBlock } from "fumadocs-ui/components/dynamic-codeblock";
import { MethodLabel } from "@/components/open-api/ui/components/method-label";
import { useQuery } from "@/components/open-api/utils/use-query";
import ServerSelect from "@/components/open-api/ui/server-select";
import {
  Collapsible,
  CollapsibleContent,
  CollapsibleTrigger,
