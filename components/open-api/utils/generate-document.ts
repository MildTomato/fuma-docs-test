...
import type {
  ...
  OperationItem,
  WebhookItem,
} from "@/components/open-api/server/api-page";
import type { GenerateOptions } from "@/components/open-api/generate";
import { idToTitle } from "@/components/open-api/utils/id-to-title";
import type { Document, TagObject } from "@/components/open-api/types";
import type { NoReference } from "@/components/open-api/utils/schema";
